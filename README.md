...
<sub>Note: Some pages may still be missing or incorrectly linked/referenced</sub>
...
| Account creations          | `/acc/creations`    | [`/acc/new_creations.php`](/src/acc/new_creations.php) |
...
| **Static/Info**            |                     |                                                        |
| Terms and Conditions       | `/terms.php`        | [`/info/terms.php`](/src/info/terms.php)               |
| Privacy Policy             | `/privacy.php`      | [`/info/privacy.php`](/src/info/privacy.php)           |
