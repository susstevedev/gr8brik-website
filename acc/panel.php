<div class="gr8-theme w3-container w3-card-2 w3-light-grey w3-padding-small w3-center">
    ...
    <div id="gr8-drawer" class="w3-hide-small gr8-drawer">
        ...
        <a href="/acc/new" class="gr8-panelbtn gr8-panelbtn-notifications w3-btn w3-large w3-white w3-hover-blue w3-mobile w3-border"><i class="fa fa-inbox" aria-hidden="true"></i>Notifications</a>&nbsp;
